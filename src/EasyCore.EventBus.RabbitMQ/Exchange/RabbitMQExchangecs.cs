...
{
    public class RabbitMQExchangecs : IRabbitMQExchangecs, IDisposable
    {
        ...
        private static readonly object LockShutdown = new();
            ...
            IServiceProvider serviceProvider)
        {
            ...
            _connection = _connectionChannel!.GetConnection(_connection);
